...
//            if (h > 1 || i > 0) {
    ...
    public String onNextHdr() {
        ...
        if ("AXAMANSARD HEALTH".equals(hmoTyp) || "AXA Mansard Local Plan".equals(hmoTyp) || "RELIANCE HEALTH".equals(hmoTyp) || "LIBERTY BLUE".equals(hmoTyp)) {
    ...
    public void setEmployeeHMOCost() {
        ...
        if (selectedHmoOption.equals("EMPLOYEE + DEPENDANTS")) {
        ...
        } else if (selectedHmoOption.equals("EMP_ONLY") && !"AXAMANSARD HEALTH".equals(selectedHmoType) && !"AXA Mansard Local Plan".equals(selectedHmoType)) {
            ...
            // result = true;
                   ...
                   ("AXAMANSARD HEALTH".equals(selectedHmoType) || "RELIANCE HEALTH".equals(selectedHmoType) || "AXA Mansard Local Plan".equals(selectedHmoType) ||
                    "LEADWAY HEALTH PREMIUM".equals(selectedHmoType) ||
                    "LEADWAY HEALTH STANDARD".equals(selectedHmoType) || "Leadway Health Local Plan".equals(selectedHmoType))) {
            ...
            System.out.println("Unside if looppppppp");
                   ...
                   ("AXAMANSARD HEALTH".equals(selectedHmoType) || "LEADWAY HEALTH PREMIUM".equals(selectedHmoType) || "AXA Mansard Local Plan".equals(selectedHmoType) ||
                    "LEADWAY HEALTH STANDARD".equals(selectedHmoType) || "Leadway Health Local Plan".equals(selectedHmoType))) {
            agedepOptions = "EMP_ONLY";
            result = true;
        ...
        if (!"AXAMANSARD HEALTH".equals(hmo_type) || !"RELIANCE HEALTH".equals(hmo_type) || !"AXA Mansard Local Plan".equals(hmo_type) ||
