...
public class NewDependentBB {
    ...
    private boolean isAllDependentAdded() {
        //commented for HmoOption only on 24-Apr-24
//        String hmoOption = com.view
//                              .uiutils
//                              .ADFUtils
//                              .getBoundAttributeValue("HmoOption")
//                              .toString();
        //added code for HmoOption only on 24-Apr-24
        ViewObject ndVo = com.view
                               .uiutils
                               .ADFUtils
                               .findIterator("NewDepHmoHdr_VOIterator")
                               .getViewObject();
        Row row = ndVo.getCurrentRow();
        String hmoOption = row.getAttribute("HmoOption")==null ? "0":row.getAttribute("HmoOption").toString();
