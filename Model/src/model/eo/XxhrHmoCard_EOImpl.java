...
// ---    Fri Jan 15 13:41:54 IST 2021
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class XxhrHmoCard_EOImpl extends EntityImpl {
    /**
    ...
    public static final int CARDREPLACEMENTDETAIL = AttributesEnum.CardReplacementDetail.index();
    ...
    public static final int CARDREQNO = AttributesEnum.CardReqNo.index();
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("model.eo.XxhrHmoCard_EO");
    }
    ...
    /**
     * Gets the attribute value for CardReplacementDetail, using the alias name CardReplacementDetail.
     * @return the value of CardReplacementDetail
     */
    public String getCardReplacementDetail() {
        return (String) getAttributeInternal(CARDREPLACEMENTDETAIL);
    }

    /**
     * Sets <code>value</code> as the attribute value for CardReplacementDetail.
     * @param value value to set the CardReplacementDetail
     */
    public void setCardReplacementDetail(String value) {
        setAttributeInternal(CARDREPLACEMENTDETAIL, value);
    }
    ...
    /**
     * Gets the attribute value for CardReqNo, using the alias name CardReqNo.
     * @return the value of CardReqNo
     */
    public String getCardReqNo() {
        return (String) getAttributeInternal(CARDREQNO);
    }

    /**
     * Sets <code>value</code> as the attribute value for CardReqNo.
     * @param value value to set the CardReqNo
     */
    public void setCardReqNo(String value) {
        setAttributeInternal(CARDREQNO, value);
    }
    ...
    protected void create(AttributeList attributeList) {
        BigDecimal cardId = new BigDecimal(0);
        SequenceImpl seq = new SequenceImpl("XXHR_HMO_CARD_S", this.getDBTransaction());
        cardId = seq.getSequenceNumber().bigDecimalValue();
