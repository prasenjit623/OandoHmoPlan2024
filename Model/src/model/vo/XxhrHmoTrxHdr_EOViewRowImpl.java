...
//            } else 
            if (!"Traditional Dependent Categorization".equals(hmoCateg)) {
                ...
                if ("AXAMANSARD HEALTH".equals(hmoType) || "LEADWAY HEALTH STANDARD".equals(hmoType) || "RELIANCE HEALTH".equals(hmoType) || "AXA Mansard Local Plan".equals(hmoType) || "Leadway Health Local Plan".equals(hmoType)) {
                    if ("Traditional Dependent Categorization".equals(hmoCateg)) {
                        if (hmoOptions.equals("Employee Only") || "EMP_ONLY".equals(hmoOptions)) {
    ...
    public BigDecimal getHmoPlanDeduction() {
        ...
        if ("DRAFT".equals(statusValue)) {
            if (("BUPA".equals(hmoType) || "CIGNA".equals(hmoType) || "AXA Mansard International Plan".equals(hmoType)) ||
                ...
                ("LEADWAY HEALTH STANDARD".equals(hmoType) &&
                 "Traditional Dependent Categorization".equals(hmoCategory)) ||
                ("Leadway Health Local Plan".equals(hmoType) &&
                 "Traditional Dependent Categorization".equals(hmoCategory)) ||
                ...
                "Traditional Dependent Categorization".equals(hmoCategory) ) ||  ("Leadway Health Local Plan".equals(hmoType) &&
                "Traditional Dependent Categorization".equals(hmoCategory) )||  ("AXA Mansard Local Plan".equals(hmoType) &&
                "Traditional Dependent Categorization".equals(hmoCategory) ) ){
...
//            vc1.addRow(vcr);
    ...
    public BigDecimal getTrans_NairaEquAmount() {
        ...
        String hmoPlan =
            this.getHmoPlan() == null ? "" : this.getHmoPlan().toString();
        if(hmoPlan.contains("2025")){
            return (BigDecimal) (nairaEquAmt.multiply(new BigDecimal(1680.10)));
        }else{
